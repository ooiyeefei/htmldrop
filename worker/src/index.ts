  ...
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    try {
      ...
      if (docMatch && request.method === 'GET') {
        ...
        const baseStyles = `<style id="htmldrop-base">body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Inter,sans-serif;line-height:1.7;color:#1e293b;max-width:800px;margin:0 auto;padding:32px 24px;}h1,h2,h3{margin:1em 0 0.5em;}p{margin:0.5em 0;}a{color:#3b82f6;}code{background:#f1f5f9;padding:2px 6px;border-radius:4px;font-size:0.9em;}pre{background:#f1f5f9;padding:16px;border-radius:8px;overflow-x:auto;}img{max-width:100%;height:auto;border-radius:8px;}table{border-collapse:collapse;width:100%;}th,td{border:1px solid #e2e8f0;padding:8px 12px;text-align:left;}th{background:#f8fafc;font-weight:600;}</style>`;
